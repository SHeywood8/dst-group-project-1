...
plot(roc_data_model_imputed$FPR, roc_data_model_imputed$TPR, type = "l", col = "blue", lwd = 2,
     xlim = c(0, 1), ylim = c(0, 1),
     main = "ROC Curve for Mode Imputed Model",
     xlab = "False Positive Rate",
     ylab = "True Positive Rate")
abline(0, 1, lty = 2, col = "grey")  # Diagonal line for random guessing
```
...
The results shocked us. The tree was quite robust to the method we chose, and the ROC curves and AUC were almost identical. Having exhausted most of the methods of dealing with missingness we explored, as well as the use of SMOTE to treat imbalance, we moved to considering ensembles.
