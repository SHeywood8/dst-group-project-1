---
title: "Using SMOTE to tackle Imbalance"
...
\begin{enumerate}
    \item \textbf{Sampling methods:} The training set is modified to produce a more balanced distribution that allows classifiers to perform in a similar manner to standard classification. These methods are sometimes called data-level modifications.
...
The AUC with no SMOTE was 0.8789168. Here, the AUC is 0.8867056, so there was a minor improvement. 
