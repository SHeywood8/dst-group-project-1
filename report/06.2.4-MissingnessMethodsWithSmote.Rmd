...
The results shocked us. The tree was quite robust to the method we chose, and the ROC curves and AUC were almost identical. Note that we have not considered imputation here, as we saw that the performance was not getting better regardless of the method we used, so we postponed the use of imputation to when we consider ensembles.
